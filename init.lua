...
do
  ...
  servers.stylua = nil -- stylua is not an LSP, and is installed via system pkg
...
do
  ...
  -- FreeBSD: use system tree-sitter parsers instead of downloading/building them.
  -- On other platforms you can uncomment the line below to auto-install parsers:
